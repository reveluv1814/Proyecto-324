...
<h5>Controlor  de los Documentos y Requisitos del Alumno <b><?php echo "".$_SESSION["alumno"]; ?></b></h5><br>
<h4>Estos Documentos serán Subidos Al Sistema</h4>

<div class="containertb">
    <p class="titulon">Los Documentos que Entrego el Alumno:</p>  
    <table class="table">
        <thead>
            <th><b>Nombre Alumno</b></th>
            <th><b>Carnet de Identidad</b></th>
            <th><b>Certificado de Nacimiento</b></th>
            <th><b>Pago Inscripción</b></th>      
        </thead>
            <tbody>
                    <tr>
