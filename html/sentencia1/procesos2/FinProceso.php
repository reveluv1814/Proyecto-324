<?php
    ...
    {       
        ...
        $sql1="update flujoprocesoseguimiento set fechafin='".date('d-m-Y')."', horafin = '".date('H:i:s')."' where flujo='F2' and proceso ='P9' and usuario='".$_SESSION["alumno"]."'";
        pg_query($con,$sql1);
        
        unset($_SESSION['alumno']);
        unset($_SESSION['kardex']);
        session_destroy();
