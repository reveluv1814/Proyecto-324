...
$sql3="insert into flujoprocesoseguimiento (flujo, proceso, usuario,fechainicio, horainicio,fechafin,horafin) values('F2','P1','".$_SESSION["id"]."' ,'".date('d-m-Y')."', '".date('H:i:s')."','".date('d-m-Y')."','".date('H:i:s')."')";
pg_query($con,$sql3);
?>